CREATE TABLE "games" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "date" datetime, "year" integer, "week" integer, "home_team_id" integer, "away_team_id" integer, "winning_team_id" integer, "weather" varchar(255), "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "players_games" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "player_id" integer, "game_id" integer, "stats_id" integer, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "team_years" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "team_id" integer, "stats_id" integer, "year" integer, "wins" integer, "losses" integer, "ties" integer, "created_at" datetime, "updated_at" datetime);
...
CREATE UNIQUE INDEX "index_teams_on_shortname" ON "teams" ("shortname");
