CREATE TABLE "games" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "date" datetime, "year" integer, "week" integer, "home_team_id" integer, "away_team_id" integer, "home_team_stats_id" integer, "away_team_stats_id" integer, "result" integer, "created_at" datetime, "updated_at" datetime);
